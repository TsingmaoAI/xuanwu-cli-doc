...
<div class="model-hero">
  <h1 class="model-title">Qwen3-32B</h1>
  <p class="model-subtitle">平衡性能与效率的主力模型，适合大多数生产场景</p>
  <div class="model-badges">
    <span class="badge badge-arch">Dense</span>
    <span class="badge badge-params">32B</span>
...
<div style="margin-top: 32px; padding-top: 16px; border-top: 1px solid var(--vp-c-divider); font-size: 13px; color: var(--vp-c-text-3);">
  <a href="https://modelscope.cn/models/Qwen/Qwen3-32B/files" style="color: var(--vp-c-text-3);">下载源: ModelScope</a>
</div>
