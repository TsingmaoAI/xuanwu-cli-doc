...
<div class="model-hero">
  <h1 class="model-title">Qwen3-30B</h1>
  <p class="model-subtitle">轻量 MoE 模型，30B 参数仅 3B 激活，高效推理</p>
  <div class="model-badges">
    <span class="badge badge-arch">MoE</span>
    <span class="badge badge-params">30B / 3B active</span>
...
<div style="margin-top: 32px; padding-top: 16px; border-top: 1px solid var(--vp-c-divider); font-size: 13px; color: var(--vp-c-text-3);">
  <a href="https://modelscope.cn/models/Qwen/Qwen3-30B/files" style="color: var(--vp-c-text-3);">下载源: ModelScope</a>
</div>
